...
config :intranet_elixir, IntranetElixir.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "intranet_elixir_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :intranet_elixir, IntranetElixirWeb.Endpoint,
  ...
  secret_key_base: "YourSecretKeyBaseHere123456789012345678901234567890123456789012345678901234567890",
  server: false

# In test we don't send emails.
config :intranet_elixir, IntranetElixir.Mailer, adapter: Swoosh.Adapters.Test
